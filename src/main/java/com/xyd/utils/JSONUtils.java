...
public class JSONUtils {
    ...
    public static String toJson(Object target, Type targetType, GsonBuilder builder) {
        ...
        try {
            ...
            Logger.w("目标对象 " + target.getClass().getName() + " 转换 JSON 字符串时，发生异常！", ex.getMessage());
     ...
     * @return
     */
    public static String toJsonByDefault(Object obj) {
    ...
    private static JsonDeserializer<Date> deser = new JsonDeserializer<Date>() {
        ...
        public Date deserialize(JsonElement json, Type typeOfT,
            ...
            if (!AppConfig.IS_HTTP_ENCODE) {
                return json == null ? null : new Date(json.getAsLong());
            }
            return json == null ? null : new Date(json.getAsJsonObject().get("time").getAsLong());
        }
    };
    ...
    public static Object fromJsonObjectByDedault(String json, @SuppressWarnings("rawtypes") Class classes) {
